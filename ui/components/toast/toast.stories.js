...
storiesOf(`${base}`.replace(/(^\/)|(\/$)/g, ''),  module)
  ...
  <div class="nds-notify_container nds-is-relative">
    <div class="nds-notify nds-notify_toast nds-theme_success" role="alert">
      ...
      <span class="nds-icon_container nds-icon-utility-success nds-m-right_small" title="Description of icon when needed">
        <svg class="nds-icon nds-icon_small nds-toast-icon" aria-hidden="true">
          <use xlink:href="./assets/icons/utility-sprite/svg/symbols.svg#success"></use>
        </svg>
      </span>
      <div class="nds-notify__content">
        <h2 class="nds-text-heading_small nds-text-align_center">
